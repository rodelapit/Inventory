...
export function StatCard({ stat }: StatCardProps) {
  ...
  return (
    <div className="overflow-hidden rounded-[30px] border border-slate-900/8 bg-[rgba(255,255,255,0.82)] p-6 shadow-[0_24px_60px_rgba(148,163,184,0.18)] transition hover:-translate-y-0.5 hover:shadow-[0_28px_70px_rgba(148,163,184,0.22)]">
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-slate-900/8 bg-[linear-gradient(135deg,rgba(255,255,255,0.95),rgba(224,242,254,0.9))] shadow-[0_18px_32px_rgba(148,163,184,0.18)]">
